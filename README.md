...
- Grafana dashboards：Linux Node Overview，以及独立 `SGLang` 目录中的 PD 合部、PD 分离与 Router 两套完整指标看板
...
- Grafana PD 分离与 Router dashboard：`/var/lib/grafana/dashboards/sglang/sglang-pd-disaggregated.json`
